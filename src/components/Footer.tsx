...
const Footer = () => {
  return (
    <div className="container mx-auto px-4 border-t-2 py-16 sm:px-6 lg:px-12 xl:px-20">
      <div className="grid grid-cols-2 gap-4 md:grid-cols-3 md:gap-8 lg:grid-cols-3 xl:grid-cols-4">
        <div className="flex flex-shrink-0 flex-col">
          ...
          <p className="mt-4 text-sm leading-none text-gray-800 ">
            Copyright © 2021 Luxe
          </p>
          <p className="mt-4 text-sm leading-none text-gray-800 ">
            All rights reserved
          ...
          <div className="mt-12 flex items-center gap-x-4">
            <button
              ...
              className="flex h-8 w-8 flex-shrink-0 cursor-pointer items-center justify-center rounded-full bg-gray-800 opacity-50 hover:bg-gray-700 focus:outline-none focus:ring-2 focus:ring-gray-800 focus:ring-offset-2"
            >
              <svg
                width="18"
                height="17"
        ...
        <div className="ml-8 flex flex-col sm:ml-0">
          ...
          <a
            ...
            className="mt-6 cursor-pointer text-base leading-4 text-gray-800 hover:text-gray-500 focus:underline focus:outline-none "
          >
            Blog
          </a>
          <a
        ...
        <div className="mt-10 hidden lg:block">
          ...
          <div className="mt-4 flex cursor-pointer items-center justify-between border border-gray-800 ">
            <input
              type="text"
              className="w-full p-4 text-base leading-4 text-gray-800 placeholder-gray-800 focus:outline-none  "
              placeholder="Enter your email"
            />
            <button
              aria-label="send"
              className="mr-4 fill-current text-gray-800 hover:text-gray-500 focus:outline-none focus:ring-2 focus:ring-gray-800 focus:ring-offset-2"
            >
              <svg
                className=""
                width="16"
      ...
      <div className="mt-10 lg:hidden ">
        ...
        <div className="mt-4 flex items-center overflow-hidden rounded-xl justify-between border border-gray-800 ">
          <input
            type="text"
            className="relative z-0 w-full rounded-md p-4 text-base leading-4 text-gray-800 placeholder-gray-800 focus:outline-none "
            placeholder="Enter your email"
          />
          <button
            aria-label="send"
            className="relative z-40 mr-4 cursor-pointer  focus:outline-none focus:ring-2 focus:ring-gray-800 focus:ring-offset-2"
          >
            <svg
