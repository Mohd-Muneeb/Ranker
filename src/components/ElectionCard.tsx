...
const ElectionCard = () => {
  ...
  return (
    <div
      ...
      onClick={() => router.push("/choice/123123")}
      className="my-2 rounded-md border-2 p-4 text-base md:w-[70vw]"
    >
      <p className="text-lg font-medium text-black hover:underline cursor-pointer">Title Here</p>
